...
function App() {
    ...
    return (
        <div className="App">
            ...
            {/*<Sidebar />*/}
            <CustomSelect data={data} styles={customStyleSelect} classNamePrefix="custom-select"/>
            <CustomSelect data={players} styles={multiStyleSelect} isMulti={true} classNamePrefix="custom-select"/>
            <CustomSelect data={numbers} styles={countStyleSelect} defaultValue={numbers[0]}
                          classNamePrefix="custom-select" menuPlacement="top"/>
        </div>
    )
}
